...
// P1#8 (review): the previous matchSpecializedAdapter export was a
// one-line wrapper around matchSpecializedAdapterFromRegistry. Removed
// — callers should import directly from `lib/adapters/index.js`.
