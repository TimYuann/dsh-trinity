...
export const version = '2.3.0-rc.2'
...
export async function apply(ctx, config) {
  ...
  // ── 2. Subscribe to live settings updates. The gated-tool reconcile
  //    lives inside registerIfEnabled's own scope watcher, so this
  //    top-level watcher only needs to refresh the in-memory ref.
