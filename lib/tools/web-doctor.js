      ...
      providers: {
        ...
        items: {
          ...
          properties: {
            ...
            // 'observed' = read off a live pool whose states came from real
            // requests; 'unprobed' = a credential exists but nothing has
            // measured it yet (health is unknown, NOT zero); 'none' = no
            // credential is configured, or the row needs none.
            credentialsSource: { type: 'string' },
